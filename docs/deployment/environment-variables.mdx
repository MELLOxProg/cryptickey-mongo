...
```env
MONGODB_URI=mongodb+srv://username:password@cluster0.abc123.mongodb.net/crypticKey?retryWrites=true&w=majority
```
...
```env
MONGODB_URI=mongodb+srv://user:pass@cluster.mongodb.net/crypticKey
PORT=3000
NODE_ENV=production
DEBUG=false
```
...
# Production
PROD_MONGODB_URI=mongodb+srv://user:pass@cluster.mongodb.net/cryptickey-prod
```
